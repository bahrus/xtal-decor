...
xtal-decor also supports listening for prop changes of specified, "native" props of the target element. This feature should be used sparingly, as it could have a performance impact.
